...
public class AdminApplyController {
    ...
    public ResponseEntity<PagingResponse> getAdminApplies(
        ...
        final Page<AdminApplyResponse> applies = applyService.getAdminApplies(page, customUser.getMemberCode());
...
//    public ResponseEntity<PagingResponse> getAdminApplyDetail(
//            @PathVariable Long sellerCode,
//            @AuthenticationPrincipal final CustomUser customUser
//    ) {
//        final AdminApplyResponse adminApplyResponse = applyService.getAdminApplies(sellerCode);
//
