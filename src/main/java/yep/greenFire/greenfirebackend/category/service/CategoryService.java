package yep.greenFire.greenfirebackend.category.service;

import lombok.RequiredArgsConstructor;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;
import yep.greenFire.greenfirebackend.category.domain.entity.Category;
import yep.greenFire.greenfirebackend.category.domain.repository.CategoryRepository;
import yep.greenFire.greenfirebackend.category.dto.request.CategoryCreateRequest;
import yep.greenFire.greenfirebackend.category.dto.request.CategoryUpdateRequest;
